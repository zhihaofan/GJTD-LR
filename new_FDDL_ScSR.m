function [hIm] = new_FDDL_ScSR(lIm, up_scale, Dh, Dl, im_h,drls)
A = double(lIm);     %待重建图像
...
cls_idx = cls_idx';
[s_idx, seg]    =   Proc_cls_idx( cls_idx );  % cls_idx
...
while Fish_nit <= 5
    ...
    [A_iter, Init_par] = update_SR_A(Init_par, Y, Dh, A_iter, Fish_par, seg, s_idx, A_l);
