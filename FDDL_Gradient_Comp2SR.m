function grad = FDDL_Gradient_Comp2SR(Xi,Ai,classn,index,tau2,tau3,drls,newpar)

%xm：第i类样本系数阵Xi Xa：整个样本的系数阵700*700  classn:样本类别数 index：当前处理类别序号
% ========================================================================
...
grad1    =   tem(:);             %4900*7     || Ai -DXi ||F^2 部分的导函数
